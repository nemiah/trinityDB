...
class FPDF {
	...
	private $fonts = array();	  //array of used fonts
	private $FontFiles = array();  //array of font files
	private $diffs = array();	  //array of encoding differences
	...
	private function _getfontpath($file = null) {
